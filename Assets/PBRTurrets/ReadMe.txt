...
Prefabs: Prefabs are located: PBR Gun Turrets Pack\Assets\PBRTurrets\Prefabs. There are two sets of Turret prefabs, on containing the test scrips and the other just the setup models. 
Simply drag and drop a prefab into your scene. Test scripts have been left on the prefabs, use at your own will, commercial or private. 

Please note the scripts are test or sample scripts, they are not intended for final development. 

All prefabs have a LOD system setup, you will need to adjust the camera distances to your needs. 
All prefabs will fire at any gameobject with the tag “Enemy”, with a rigidbody and collider.
...
Go_barrel: Gun barrel
firingRange: Range in unity units in with the turret will aim and fire at the “Enemy”
muzzelFlash: Muzzle flash particle system
fireRate: speed at which the gun will fire
...
go_GunBody:    Gun body    
go_barrel: Gun barrel
spawnPoints: array of barrels rockets can spawn from
firingRange: Range in unity units in with the turret will aim and fire at the “Enemy”
fireRate: speed at which the gun will fire
projectile: rocket prefab

Snap Settings:
simply drag and drop them into your scene and use the following snap settings. Please note your handle setting MUST be set to Global and Pivot.
Move X: 1.3
Move Y: 0.5
Move Z:	1.125
Rotation: 60
